        ...
        <div class="col-md-6 pb-4">
          <div
            class="
              position-relative
              bg-secondary
              text-center text-md-right text-white
              mb-2
              py-5
              px-5
            "
        ...
        <div class="col-md-6 pb-4">
          <div
            class="
              position-relative
              bg-secondary
              text-center text-md-left text-white
              mb-2
              py-5
              px-5
            "
    ...
    <div class="container-fluid pt-5">
      ...
      <div class="row px-xl-5 pb-3">
        <div
          ...
          v-for="(product, index) in products8"
          :key="index"
        >
          <div class="card product-item border-0 mb-4">
            ...
            >
              <a
                ...
                @click.prevent="$router.push({ name: 'detail' })"
...
export default {
  components: { TemplateView, NavbarComp, FeaturedComp, CategoriesComp },
  computed: {
    ...mapGetters({
      products8: "GET_PRODUCTS8",
    }),
  },
};
</script>
